<template>
  <div class="app-container calendar-list-container">
    <div class="filter-container">
      <el-input @keyup.enter.native="handleFilter" style="width: 200px;" class="filter-item" placeholder="帐号/手机号/用户名" v-model="listQuery.title">
      </el-input>

      <el-select clearable style="width: 90px" class="filter-item" v-model="listQuery.importance" placeholder="性别">
      ...
      <el-checkbox class="filter-item" @change='tableKey=tableKey+1' v-model="showRealnameAuth">显示实名认证</el-checkbox>
      <el-checkbox class="filter-item" @change='tableKey=tableKey+1' v-model="showCarAuth">显示司机认证</el-checkbox>
