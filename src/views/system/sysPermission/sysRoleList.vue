<template>
  <div class="app-container calendar-list-container">
    <div class="filter-container">
      ...
      <el-button class="filter-item" style="margin-left: 10px;" @click="handleCreate" type="primary" icon="edit" v-permit-func="1111" >添加</el-button>
    </div>
    ...
    <el-table :key='tableKey' :data="list" v-loading="listLoading" element-loading-text="给我一点时间" border fit highlight-current-row style="width: 100%">
      ...
      <el-table-column align="center" label="操作" width="400">
        <template scope="scope">
          <el-button size="small" type="danger" @click="handleDeleteRole(scope.row)" v-permit-func="1112" > 删除 </el-button>
          <el-button size="small" type="danger" @click="handleUpdate(scope.row)"  v-permit-func="1113" >编辑</el-button>
          <el-button size="small" type="danger" @click="handleRoleMenu(scope.row)"  v-permit-func="1114" >关联菜单功能点</el-button>
        </template>
      </el-table-column>
    </el-table>
